    ...
    return (
      ...
      >
        ...
        <div className="sticky top-[-32px] bg-[#F8FAFC] pt-2 pb-3 z-10">
          <div className={`bg-white border-x border-b border-slate-200 border-t-4 ${type === 'vendedor' ? 'border-[#1B4D3E]' : getBorderColorClass(color)} rounded-xl p-4 shadow-sm text-left`}>
            {type === 'status' ? (
              <>
