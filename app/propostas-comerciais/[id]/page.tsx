...
const curatedPhotos = [
  {
    id: 'money_bag',
    src: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=200',
    title: 'Saco de Moedas e Ouro',
    tags: ['dinheiro', 'money', 'cifrão', 'custo', 'finanças', 'reais', 'dollar', 'ouro', 'investimento', 'financeiro', 'moeda'],
    isPro: true
  },
  {
    id: 'money_stack',
    src: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?q=80&w=200',
    title: 'Notas de Dólar',
    tags: ['dinheiro', 'money', 'cifrão', 'custo', 'finanças', 'reais', 'dollar', 'carteira', 'financeiro', 'crescimento'],
    isPro: false
  },
  {
    id: 'money_reais',
    src: 'https://images.unsplash.com/photo-1618044733300-9472054094ee?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1618044733300-9472054094ee?q=80&w=200',
    title: 'Cédulas de Dinheiro',
    tags: ['dinheiro', 'money', 'cifrão', 'custo', 'finanças', 'reais', 'cédula', 'financeiro', 'economia'],
    isPro: true
  },
  {
    id: 'piggy_bank',
    src: 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=200',
    title: 'Cofrinho de Porquinho',
    tags: ['dinheiro', 'money', 'cifrão', 'custo', 'finanças', 'economia', 'poupança', 'cofrinho', 'investimento'],
    isPro: false
  },
  {
    id: 'calculator_fin',
    src: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=200',
    title: 'Calculadora e Planilhas',
    tags: ['dinheiro', 'money', 'custo', 'finanças', 'calculadora', 'planilha', 'contabilidade', 'orcamento', 'fiscal'],
    isPro: false
  },
  {
    id: 'clean_prof',
    src: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=200',
    title: 'Profissional de Limpeza',
    tags: ['limpeza', 'clean', 'facilities', 'faxina', 'conservação', 'higienização', 'escritório', 'zeladoria'],
    isPro: true
  },
  {
    id: 'clean_bucket',
    src: 'https://images.unsplash.com/photo-1583907659441-ae224b45946a?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1583907659441-ae224b45946a?q=80&w=200',
    title: 'Produtos de Limpeza',
    tags: ['limpeza', 'clean', 'facilities', 'faxina', 'produtos', 'balde', 'desinfetante', 'higienização'],
    isPro: false
  },
  {
    id: 'clean_vacuum',
    src: 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=200',
    title: 'Aspirador de Pó',
    tags: ['limpeza', 'clean', 'facilities', 'faxina', 'aspirador', 'carpete', 'manutenção', 'conservação'],
    isPro: false
  },
  {
    id: 'clean_window',
    src: 'https://images.unsplash.com/photo-1603712760398-3f62f37e5c1a?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1603712760398-3f62f37e5c1a?q=80&w=200',
    title: 'Limpeza de Vidros',
    tags: ['limpeza', 'clean', 'facilities', 'faxina', 'vidro', 'janela', 'altura', 'fachada', 'conservação'],
    isPro: true
  },
  {
    id: 'sec_cctv',
    src: 'https://images.unsplash.com/photo-1557597774-9d273605dfa9?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1557597774-9d273605dfa9?q=80&w=200',
    title: 'Monitoramento CCTV',
    tags: ['segurança', 'security', 'cctv', 'monitoramento', 'câmeras', 'vigilância', 'central', 'controle'],
    isPro: true
  },
  {
    id: 'sec_camera',
    src: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=200',
    title: 'Câmera de Segurança',
    tags: ['segurança', 'security', 'câmera', 'vigilância', 'proteção', 'monitoramento', 'patrulha'],
    isPro: false
  },
  {
    id: 'sec_biometrics',
    src: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&w=200',
    title: 'Leitor Biométrico',
    tags: ['segurança', 'security', 'biometria', 'digital', 'acesso', 'controle', 'tecnologia', 'portaria'],
    isPro: false
  },
  {
    id: 'sec_badge',
    src: 'https://images.unsplash.com/photo-1605379399642-870262d3d051?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1605379399642-870262d3d051?q=80&w=200',
    title: 'Vigilante Profissional',
    tags: ['segurança', 'security', 'vigilante', 'guarda', 'patrulha', 'portaria', 'agente', 'controle'],
    isPro: true
  },
  {
    id: 'corp_glass',
    ...
    tags: ['prédio', 'building', 'escritório', 'corporativo', 'fachada', 'sede', 'arquitetura', 'moderno'],
    isPro: false
  },
  {
    id: 'corp_office',
    src: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=200',
    title: 'Escritório Moderno',
    tags: ['prédio', 'building', 'escritório', 'corporativo', 'coworking', 'salas', 'mesa', 'infraestrutura'],
    isPro: false
  },
  {
    id: 'corp_meeting',
    src: 'https://images.unsplash.com/photo-1517502884422-41eaaced0168?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1517502884422-41eaaced0168?q=80&w=200',
    title: 'Sala de Reunião',
    tags: ['prédio', 'escritório', 'reunião', 'boardroom', 'corporativo', 'palestra', 'conferência'],
    isPro: true
  },
  {
    id: 'corp_lobby',
    src: 'https://images.unsplash.com/photo-1568992687947-868a62a9f521?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1568992687947-868a62a9f521?q=80&w=200',
    title: 'Recepção / Hall',
    tags: ['prédio', 'escritório', 'recepção', 'lobby', 'portaria', 'atendimento', 'hall'],
    isPro: false
  },
  {
    id: 'team_hands',
    src: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=200',
    title: 'Parceria de Equipe',
    tags: ['equipe', 'team', 'pessoas', 'sucesso', 'colaboradores', 'parceria', 'união', 'trabalho'],
    isPro: false
  },
  {
    id: 'team_meeting',
    src: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=200',
    title: 'Equipe Provelo',
    tags: ['equipe', 'team', 'pessoas', 'negócios', 'apresentação', 'colaboradores', 'profissionais'],
    isPro: true
  },
  {
    id: 'team_handshake',
    src: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=200',
    title: 'Aperto de Mão',
    tags: ['equipe', 'pessoas', 'negócios', 'parceria', 'contrato', 'fechamento', 'sucesso', 'acordo'],
    isPro: false
  },
  {
    id: 'suc_target',
    src: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=200',
    title: 'Alcançando Metas',
    tags: ['sucesso', 'metas', 'alvo', 'performance', 'resultado', 'crescimento', 'liderança'],
    isPro: true
  },
  {
    id: 'suc_trophy',
    src: 'https://images.unsplash.com/photo-1578269174936-2709b5a5c0e5?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1578269174936-2709b5a5c0e5?q=80&w=200',
    title: 'Troféu de Ouro',
    tags: ['sucesso', 'conquistas', 'troféu', 'prêmio', 'qualidade', 'liderança', 'vitória'],
    isPro: true
  },
  {
    id: 'suc_chart',
    src: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=600',
    thumb: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=200',
    title: 'Crescimento Financeiro',
    tags: ['sucesso', 'crescimento', 'performance', 'gráficos', 'kpis', 'lucro', 'vendas'],
    isPro: false
  }
];

const curatedIcons = [
  { name: 'DollarSign', title: 'Cifrão / Dólar', color: '#16a34a', tags: ['dinheiro', 'money', 'cifrão', 'custo', 'finanças', 'pagamento', 'economizar', 'juros'] },
  { name: 'Coins', title: 'Moedas de Ouro', color: '#eab308', tags: ['dinheiro', 'money', 'moeda', 'ouro', 'finanças', 'custo', 'economizar'], isPro: true },
  { name: 'Wallet', title: 'Carteira Financeira', color: '#854d0e', tags: ['dinheiro', 'carteira', 'finanças', 'pagamento', 'crédito'] },
  { name: 'CreditCard', title: 'Cartão de Crédito', color: '#2563eb', tags: ['dinheiro', 'cartão', 'crédito', 'pagamento', 'banco'] },
  { name: 'PiggyBank', title: 'Cofrinho de Porco', color: '#db2777', tags: ['dinheiro', 'economia', 'poupança', 'investimento', 'porco'] },
  { name: 'TrendingUp', title: 'Crescimento / Lucro', color: '#16a34a', tags: ['dinheiro', 'sucesso', 'crescimento', 'lucro', 'vendas', 'kpis', 'gráfico'], isPro: true },
  { name: 'Sparkles', title: 'Brilho / Limpo', color: '#06b6d4', tags: ['limpeza', 'clean', 'brilho', 'qualidade', 'conservação', 'higienização'] },
  { name: 'Trash2', title: 'Lixeira / Descarte', color: '#dc2626', tags: ['limpeza', 'lixeira', 'descarte', 'resíduos', 'organização'] },
  { name: 'Flame', title: 'Higienização Térmica', color: '#f97316', tags: ['limpeza', 'fogo', 'calor', 'esterilizar', 'higienização'] },
  { name: 'Wind', title: 'Vento / Ar Puro', color: '#3b82f6', tags: ['limpeza', 'ar', 'vento', 'frescor', 'climatização'] },
  { name: 'Shield', title: 'Escudo Protetor', color: '#1e40af', tags: ['segurança', 'security', 'escudo', 'proteção', 'alerta'] },
  { name: 'ShieldCheck', title: 'Escudo Verificado', color: '#16a34a', tags: ['segurança', 'security', 'verificado', 'proteção', 'sucesso'], isPro: true },
  { name: 'Lock', title: 'Cadeado Fechado', color: '#dc2626', tags: ['segurança', 'cadeado', 'bloqueio', 'acesso', 'proteção'] },
  { name: 'Key', title: 'Chave de Acesso', color: '#ca8a04', tags: ['segurança', 'chave', 'acesso', 'controle', 'portaria'] },
  { name: 'Eye', title: 'Olho / Vigilância', color: '#2563eb', tags: ['segurança', 'monitoramento', 'cctv', 'vigilância', 'visão'] },
  { name: 'Building', title: 'Prédio Comercial', color: '#475569', tags: ['prédio', 'building', 'escritório', 'sede', 'infraestrutura', 'corporativo'] },
  { name: 'Building2', title: 'Torres Corporativas', color: '#1e3a8a', tags: ['prédio', 'building', 'escritório', 'sede', 'infraestrutura', 'corporativo'], isPro: true },
  { name: 'Home', title: 'Casa / Residência', color: '#0f766e', tags: ['prédio', 'casa', 'residência', 'lar', 'facilities'] },
  { name: 'Warehouse', title: 'Galpão / Depósito', color: '#b45309', tags: ['prédio', 'galpão', 'depósito', 'estoque', 'logística'] },
  { name: 'Factory', title: 'Fábrica / Indústria', color: '#be123c', tags: ['prédio', 'fábrica', 'indústria', 'produção', 'operacional'] },
  { name: 'Users', title: 'Grupo / Equipe', color: '#0284c7', tags: ['equipe', 'team', 'pessoas', 'grupo', 'colaboradores', 'parceria'] },
  { name: 'UserCheck', title: 'Colaborador Aprovado', color: '#16a34a', tags: ['equipe', 'colaborador', 'aprovado', 'pessoas', 'contratação'] },
  { name: 'UserPlus', title: 'Adicionar Membro', color: '#2563eb', tags: ['equipe', 'contratação', 'adicionar', 'pessoas', 'crescimento'] },
  { name: 'Smile', title: 'Satisfação / Cliente', color: '#ca8a04', tags: ['equipe', 'cliente', 'satisfação', 'sorriso', 'atendimento'] },
  { name: 'ThumbsUp', title: 'Aprovado / Sucesso', color: '#16a34a', tags: ['equipe', 'sucesso', 'aprovado', 'curtir', 'qualidade'] },
  { name: 'Target', title: 'Alvo / Meta', color: '#dc2626', tags: ['sucesso', 'meta', 'alvo', 'objetivo', 'performance'] },
  { name: 'Award', title: 'Medalha / Selo', color: '#ca8a04', tags: ['sucesso', 'medalha', 'selo', 'qualidade', 'certificação'], isPro: true },
  { name: 'Trophy', title: 'Troféu de Ouro', color: '#ca8a04', tags: ['sucesso', 'troféu', 'vitória', 'primeiro', 'qualidade'] },
  { name: 'Star', title: 'Estrela / Destaque', color: '#eab308', tags: ['sucesso', 'estrela', 'destaque', 'favorito', 'avaliação'] },
  { name: 'Crown', title: 'Coroa Premium', color: '#db2777', tags: ['sucesso', 'coroa', 'liderança', 'premium', 'destaque'], isPro: true },
  { name: 'Truck', title: 'Caminhão de Entrega', color: '#d97706', tags: ['logística', 'transporte', 'caminhão', 'entrega', 'distribuição'] },
  { name: 'MapPin', title: 'Localização', color: '#e11d48', tags: ['logística', 'endereço', 'localização', 'cobertura', 'filial'] },
  { name: 'Globe', title: 'Globo / Cobertura', color: '#2563eb', tags: ['logística', 'globo', 'site', 'cobertura', 'nacional'] },
  { name: 'Box', title: 'Caixa de Encomenda', color: '#854d0e', tags: ['logística', 'caixa', 'encomenda', 'estoque', 'pacote'] }
];
