    ...
    <>
      ...
      <div className={presentationMode 
         ...
         : "w-full bg-slate-900/5 rounded-3xl p-8 border border-slate-200/40 flex justify-center items-center overflow-hidden relative"
                     ...
                     <button
                        type="button"
                        onClick={() => setCurrentSlide(currentSlide === totalSlides ? 1 : currentSlide + 1)}
                     ...
                     <div className={presentationMode
                        ...
                        {hasDynamicSlides ? (
                           (() => {
                              ...
                              let slideData: any = {};
                              try {
                                 slideData = JSON.parse(activeSlide.texto);
                              } catch (e) {
                                 slideData = { layout: 'texto', tituloSlide: activeSlide.titulo, subtitulo: '', conteudo: activeSlide.texto };
                              }
                              
                              const layout = slideData.layout || 'texto';
                              const tituloSlide = slideData.tituloSlide || activeSlide.titulo;
                                             ...
                                             >
                                                {el.type === 'text' && (
                                                   el.content.includes('[TERMO_ACEITE]') ? (
                                                      <div 
                                                         className="w-full h-full p-4 flex flex-col justify-between bg-slate-900/5 hover:bg-slate-900/10 border-2 border-[#1B4D3E]/30 border-dashed rounded-3xl select-none relative transition-all"
                                                         style={{
                                                            fontSize: '1.1cqw',
                                                         ...
                                                         {proposta.statusAssinatura === 'ASSINADO' ? (
                                                            <div className="flex flex-col h-full justify-between gap-2.5">
                                                               <div className="flex items-center justify-between border-b border-[#1B4D3E]/20 pb-2">
                                                                  <span className="text-[1.2cqw] font-black text-[#1B4D3E] flex items-center gap-1.5 tracking-wider uppercase">
                                                                     <Icons.ShieldCheck className="w-[1.6cqw] h-[1.6cqw] text-[#1B4D3E]" /> ACEITE CONFIRMADO
                                                                  </span>
                                                                  <span className="text-[0.8cqw] font-bold bg-emerald-100 text-emerald-800 border border-emerald-300 px-3 py-0.5 rounded-full uppercase tracking-wider">
                                                                     ✓ Assinado
                                                                  </span>
                                                               </div>

                                                               <div className="grid grid-cols-12 gap-4 items-center flex-1">
                                                                  <div className="col-span-7 space-y-1.5 text-[0.95cqw] text-slate-700 font-semibold">
                                                                     <div className="space-y-0.5">
                                                                        <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Assinado por</div>
                                                                        <div className="text-slate-900 text-[1.1cqw] font-extrabold leading-tight">{proposta.nomeAssinante}</div>
                                                                     </div>
                                                                     <div className="grid grid-cols-2 gap-2">
                                                                        <div className="space-y-0.5">
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Documento (CPF)</div>
                                                                           <div className="font-mono text-[0.9cqw] text-slate-800 leading-none">{proposta.cpfAssinante}</div>
                                                                        </div>
                                                                        <div className="space-y-0.5">
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Endereço IP</div>
                                                                           <div className="font-mono text-[0.9cqw] text-slate-800 leading-none">{proposta.ipAssinante}</div>
                                                                        </div>
                                                                     </div>
                                                                     <div className="space-y-0.5">
                                                                        <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Data / Hora do Aceite</div>
                                                                        <div className="text-[0.9cqw] text-slate-800 leading-none">{proposta.dataAssinatura ? new Date(proposta.dataAssinatura).toLocaleString('pt-BR') : '-'}</div>
                                                                     </div>
                                                                  </div>

                                                                  <div className="col-span-5 h-full flex flex-col justify-center items-center">
                                                                     <div className="w-full aspect-[8/3] bg-emerald-50 border border-dashed border-emerald-300 rounded-2xl p-2.5 flex items-center justify-center relative overflow-hidden shadow-inner">
                                                                        {proposta.assinaturaBase64 ? (
                                                                           ...
                                                                           <span className="text-[0.8cqw] text-emerald-800/60 font-bold uppercase tracking-wider">Assinatura</span>
                                                                        )}
                                                                     </div>
                                                                     <span className="text-[0.6cqw] text-slate-400 font-bold uppercase tracking-widest mt-1.5">Assinatura Digital SmartBid</span>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         ) : (
                                                            <div className="flex flex-col h-full justify-between gap-2.5">
                                                               <div className="flex items-center justify-between border-b border-amber-500/20 pb-2">
                                                                  <span className="text-[1.2cqw] font-black text-amber-800 flex items-center gap-1.5 tracking-wider uppercase">
                                                                     <Icons.Lock className="w-[1.6cqw] h-[1.6cqw] text-amber-700" /> Aguardando Aceite
                                                                  </span>
                                                                  <span className="text-[0.8cqw] font-bold bg-amber-100 text-amber-800 border border-amber-300 px-3 py-0.5 rounded-full uppercase tracking-wider">
                                                                     ⚡ Pendente
                                                                  </span>
                                                               </div>
                                                               ...
                                                               <div className="grid grid-cols-12 gap-4 items-center flex-1">
                                                                  <div className="col-span-7 space-y-1.5 text-[0.95cqw] text-slate-700 font-semibold">
                                                                     <div className="grid grid-cols-2 gap-2">
                                                                        <div>
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Razão Social</div>
                                                                           <div className="text-slate-900 text-[0.95cqw] font-bold truncate leading-tight">{proposta.cliente?.razaoSocial || proposta.cliente?.cliente || "Não informada"}</div>
                                                                        </div>
                                                                        <div>
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">CNPJ do Cliente</div>
                                                                           <div className="font-mono text-[0.9cqw] text-slate-800 leading-none">{proposta.cliente?.cnpj || "Não informado"}</div>
                                                                        </div>
                                                                     </div>
                                                                     <div className="grid grid-cols-2 gap-2">
                                                                        <div>
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Contato</div>
                                                                           <div className="text-slate-900 text-[0.95cqw] font-bold truncate leading-tight">{proposta.cliente?.contato || "Representante Legal"}</div>
                                                                        </div>
                                                                        <div>
                                                                           <div className="text-[0.7cqw] text-slate-400 font-black uppercase tracking-widest leading-none">Data de Início</div>
                                                                           <div className="text-slate-900 text-[0.95cqw] font-bold leading-none">{proposta.cliente?.dataInicio ? new Date(proposta.cliente.dataInicio + 'T12:00:00').toLocaleDateString('pt-BR') : "A definir"}</div>
                                                                        </div>
                                                                     </div>
                                                                  </div>

                                                                  <div className="col-span-5 h-full flex flex-col justify-center items-center">
                                                                     <div className="w-full aspect-[8/3] bg-slate-100 border border-dashed border-slate-300 rounded-2xl p-2.5 flex flex-col items-center justify-center relative overflow-hidden shadow-inner text-center gap-0.5">
                                                                        <span className="text-[0.8cqw] text-slate-500 font-black uppercase tracking-wider leading-none">Painel de Assinatura</span>
                                                                        <span className="text-[0.6cqw] text-slate-400 font-semibold leading-tight">Assine eletronicamente através do botão de aprovação no topo</span>
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                            </div>
                              ...
                              if (layout === 'cobertura') {
                                 if (coverStyle === 'provelo_split') {
                                    ...
                                    return (
                                       <div className={`absolute inset-0 w-full h-full grid grid-cols-12 gap-8 p-16 z-10 overflow-hidden bg-white select-none text-slate-800 animate-fadeIn ${fontClass}`} style={{ ...baseStyle, backgroundColor: bgColor }}>
                                          ...
                                          <div className="col-span-7 flex flex-col justify-between h-full pr-6 z-20">
                                             ...
                                             <div className="pt-4 border-t border-slate-100 flex gap-8 text-[9px] font-extrabold text-slate-400">
                                          ...
                                          <div className="col-span-5 h-full relative flex items-center justify-end overflow-hidden z-20 pr-4">
                                             <div className="w-[85%] h-[95%] rounded-l-[180px] overflow-hidden border-4 border-slate-100/50 shadow-2xl relative">
                                                <img 
                                                   src={finalSideImage} 
                                    ...
                                    return (
                                       <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-16 z-10 text-white overflow-hidden bg-slate-950 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                          <img 
                                             src={finalBgImage} 
                                             alt="Capa Fundo" 
                                          ...
                                          <div className="relative z-20 flex flex-col justify-center items-center h-full w-full space-y-12">
                                             ...
                                             <div className="w-full max-w-2xl border-2 border-white rounded-full bg-white/10 px-12 py-4 shadow-xl backdrop-blur-md text-center hover:bg-white/15 transition-all duration-300 transform hover:scale-[1.01]">
                                                <span className="text-white text-base font-black tracking-[0.25em] uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.15)]" style={{ color: titleColor || undefined }}>
                                          ...
                                          <div className="relative z-20 flex justify-between items-end w-full text-white/70 text-[10px] font-extrabold uppercase tracking-wider pr-28">
                                             <div className="flex gap-16">
                                                <div className="space-y-1">
                                                   <div>Cliente: <strong className="text-white">{proposta.cliente?.nomeFantasia || proposta.cliente?.razaoSocial || "Cliente Não Informado"}</strong></div>
                                             ...
                                             <span className="text-[9px] font-black text-white/80 bg-white/10 px-2.5 py-0.5 rounded backdrop-blur-xs">{String(currentSlide).padStart(2, '0')}</span>
                                          </div>
                                       </div>
                                    );
                                 }
                              ...
                              if (layout === 'quem_somos') {
                                 ...
                                 return (
                                    <div className={`absolute inset-0 w-full h-full grid grid-cols-12 z-10 overflow-hidden bg-slate-900 select-none text-white animate-fadeIn ${fontClass}`} style={baseStyle}>
                                       {/* Faixa Vermelha Vertical à Esquerda */}
                                       <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                       
                                       {/* Coluna Esquerda: Solid Red (40% width) */}
                                       <div className="col-span-5 bg-[#ef4444] p-16 flex flex-col justify-center space-y-6 z-20 pl-20 relative">
                                       ...
                                       {/* Coluna Direita: Imagem Industrial + 2 Cards Verticais */}
                                       <div className="col-span-7 h-full relative flex items-center justify-center p-12 z-10">
                                          ...
                                          <div className="relative z-20 flex gap-8 w-full max-w-xl justify-center items-center">
                                             <div className="w-1/2 aspect-[3/4] rounded-3xl overflow-hidden border-[6px] border-[#ef4444] shadow-2xl transform hover:scale-105 transition-all duration-300">
                                                <img src={finalSideImage} alt="Workspace 1" className="w-full h-full object-cover" />
                                             </div>
                                             <div className="w-1/2 aspect-[3/4] rounded-3xl overflow-hidden border-[6px] border-[#ef4444] shadow-2xl transform hover:scale-105 transition-all duration-300 mt-12">
                              ...
                              if (layout === 'agradecimento') {
                                 return (
                                    <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-16 z-10 animate-fadeIn bg-white overflow-hidden text-slate-800 ${fontClass}`} style={{ ...baseStyle, backgroundColor: bgColor }}>
                              ...
                              if (layout === 'valores') {
                                 if (coverStyle === 'provelo_split') {
                                    ...
                                    return (
                                       <div className={`absolute inset-0 w-full h-full grid grid-cols-12 p-16 z-10 overflow-hidden bg-white select-none text-slate-800 animate-fadeIn ${fontClass}`} style={{ ...baseStyle, backgroundColor: bgColor }}>
                                          {/* Faixa Vermelha Vertical à Esquerda */}
                                          <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                          
                                          {/* Coluna Esquerda: Valores */}
                                          <div className="col-span-7 flex flex-col justify-between h-full pr-8 z-20 text-left pl-6">
                                             <div>
                                                <h2 className="text-4xl font-black uppercase text-slate-900 tracking-tight leading-none mb-6" style={{ color: titleColor || undefined }}>{replaceTags(tituloSlide)}</h2>
                                          ...
                                          {/* Coluna Direita: Foto com Mascara e Faixa Vermelha no Fundo */}
                                          <div className="col-span-5 h-full relative flex items-center justify-end overflow-hidden z-20">
                                             {/* Faixa vermelha diagonal de fundo */}
                                             <div className="absolute right-0 bottom-0 top-0 w-[45%] bg-[#ef4444] rounded-l-[100px] z-10"></div>
                                             
                                             <div className="w-[85%] h-[95%] rounded-l-[180px] overflow-hidden border-4 border-slate-100/50 shadow-2xl relative z-20 mr-4">
                                                <img 
                                                   src={finalSideImage} 
                                                   alt="Values Image" 
                                                   className="w-full h-full object-cover"
                                                />
                                                {/* Mini logo overlay on right */}
                                                <div className="absolute bottom-6 right-6 flex items-center gap-1.5 bg-slate-900/60 backdrop-blur-md px-3 py-1 rounded border border-white/10">
                                                   <img src={companyLogo} alt="Logo" className="max-h-5 w-auto object-contain filter brightness-0 invert" />
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    return (
                                       <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-16 z-10 animate-fadeIn bg-white text-slate-800 rounded-2xl border border-slate-200 select-none ${fontClass}`} style={{ ...baseStyle, backgroundColor: bgColor }}>
                              ...
                              if (layout === 'performance') {
                                 ...
                                 return (
                                    <div className={`absolute inset-0 w-full h-full grid grid-cols-12 p-16 z-10 overflow-hidden bg-[#fafafa] select-none text-slate-800 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                       {/* Faixa Vermelha Vertical à Esquerda */}
                                       <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                       
                                       {/* Esquerda: Titulo + Descrição + Foto Prédio */}
                                       <div className="col-span-5 flex flex-col justify-between h-full pr-4 text-left pl-6 z-20">
                                       ...
                                       {/* Direita: Duas caixas vermelhas de Estatísticas + Textos explicativos */}
                                       <div className="col-span-7 flex flex-col justify-center space-y-6 pl-6 z-20 text-left">
                                          ...
                                          <div className="pt-4 border-t border-slate-200 flex justify-between items-center w-full mt-4">
                                             ...
                                             <span className="text-[8px] font-black text-slate-500 bg-slate-100 px-2 py-0.5 rounded">{String(currentSlide).padStart(2, '0')}</span>
                                          </div>
                                       </div>
                                    </div>
                                 );
                                 ...
                                 if (servicosStyle === 'provelo_grid') {
                                    return (
                                       <div className={`absolute inset-0 w-full h-full grid grid-cols-12 p-16 z-10 overflow-hidden bg-[#fafafa] select-none text-slate-800 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                          ...
                                          {/* Esquerda: Título */}
                                          <div className="col-span-4 flex flex-col justify-center h-full pr-4 text-left pl-6 z-20">
                                          ...
                                          {/* Direita: Grid 3x2 de Cards */}
                                          <div className="col-span-8 grid grid-cols-3 gap-6 items-center z-20 py-2">
                                             {[
                              ...
                              if (layout === 'atuacao') {
                                 return (
                                    <div className={`absolute inset-0 w-full h-full grid grid-cols-12 p-16 z-10 overflow-hidden bg-white select-none text-slate-800 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                       {/* Faixa Vermelha Vertical à Esquerda */}
                                       <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                       
                                       {/* Coluna Esquerda: Estatísticas */}
                                       <div className="col-span-6 flex flex-col justify-between h-full pr-8 text-left pl-6 z-20">
                                          ...
                                          {/* Mini Cards Vermelhos Verticais */}
                                          <div className="space-y-2.5 my-auto pt-4">
                                             {[
                                                ...
                                                <div key={sIdx} className="bg-[#ef4444] text-white px-5 py-2.5 rounded-2xl flex items-center gap-4 shadow-md w-full border border-white/10 hover:scale-[1.01] transition-transform">
                                       ...
                                       {/* Coluna Direita: Mapa Interativo do Brasil */}
                                       <div className="col-span-6 h-full relative flex items-center justify-center p-4 z-20">
                                          {/* Banner Vermelho Provelo at Right Side of Map */}
                                          <div className="absolute right-0 bottom-0 top-0 w-[45%] bg-[#ef4444] rounded-l-[100px] z-10"></div>
                                          
                                          <div className="w-[85%] h-[95%] bg-[#fafafa]/80 rounded-[40px] border border-slate-200/50 shadow-2xl p-6 relative z-20 flex flex-col justify-center items-center">
                                             {/* Logo Provelo Header on Map */}
                              ...
                              if (layout === 'gestao') {
                                 ...
                                 return (
                                    <div className={`absolute inset-0 w-full h-full grid grid-cols-12 p-16 z-10 overflow-hidden bg-white select-none text-slate-800 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                       {/* Faixa Vermelha Vertical à Esquerda */}
                                       <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                       {/* Faixa Vermelha à Direita */}
                                       <div className="absolute right-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-l-2xl z-30"></div>

                                       <div className="col-span-7 flex flex-col justify-between h-full pr-8 text-left pl-6 z-20">
                                       ...
                                       <div className="col-span-5 h-full relative flex items-center justify-center p-4 z-20 pr-6">
                                          <div className="w-full relative shadow-2xl rounded-2xl overflow-hidden border border-slate-200 bg-slate-900 p-2 transform hover:rotate-[-1deg] transition-all duration-300">
                                             {/* Laptop Screen */}
                              ...
                              if (layout === 'fundadores') {
                                 return (
                                    <div className={`absolute inset-0 w-full h-full flex flex-col justify-between z-10 overflow-hidden bg-white select-none text-slate-800 animate-fadeIn ${fontClass}`} style={baseStyle}>
                                       {/* Faixa Vermelha Vertical à Esquerda */}
                                       <div className="absolute left-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-r-2xl z-30"></div>
                                       {/* Faixa Vermelha à Direita */}
                                       <div className="absolute right-0 top-0 bottom-0 w-4 bg-[#ef4444] rounded-l-2xl z-30"></div>
                                       ...
                                       {/* Parte Inferior: Vermelha com os Avatares em Circulo/Scallop */}
                                       <div className="h-[55%] bg-[#ef4444] relative flex items-center justify-around px-16 pl-20 pr-20 z-20 border-t-4 border-white shadow-inner">
                                          {[
                                             ...
                                             <div key={fIdx} className="flex flex-col items-center text-center space-y-2 transform hover:scale-105 transition-transform duration-300">
                                                {/* Scalloped Avatar shape */}
                                    ...
                                    <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-16 z-10 animate-fadeIn bg-white text-slate-800 rounded-2xl border border-slate-200 select-none ${fontClass}`} style={{ ...baseStyle, backgroundColor: bgColor }}>
                                       ...
                                       <div className="flex flex-col justify-between h-full relative z-10 text-left">
                                          ...
                                          <div className="flex justify-between items-center w-full text-slate-400 text-[9px] font-bold uppercase tracking-wider pt-2 border-t border-slate-100 pr-28">
                                             ...
                                             <span className="text-[#1e4480] bg-slate-100 px-2.5 py-0.5 rounded font-black">{String(currentSlide).padStart(2, '0')}</span>
                                          </div>
                                       </div>
                                    </div>
                                 );
                              ...
                              if (layout === 'tabela') {
                                 ...
                                 return (
                                    <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-12 z-10 animate-fadeIn bg-white text-slate-800 rounded-2xl border border-slate-200 select-none ${fontClass}`} style={baseStyle}>
                              ...
                              if (layout === 'aceite') {
                                 return (
                                    <div className={`absolute inset-0 w-full h-full flex flex-col justify-between p-12 z-10 animate-fadeIn bg-[#1e4480] text-white rounded-2xl border border-slate-200 select-none ${fontClass}`} style={baseStyle}>
                                       ...
                                       <div className="relative z-10 flex flex-col h-full justify-between text-left">
                                          ...
                                          <div className="flex justify-between items-center border-t border-white/20 pt-4 mt-auto pr-28">
                                             ...
                                             <span className="text-[9px] font-black text-white bg-white/10 px-2.5 py-0.5 rounded">{String(currentSlide).padStart(2, '0')}</span>
                                          </div>
                                       </div>
                                    </div>
                                 );
