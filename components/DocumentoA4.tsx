    ...
    <div className="mt-8 pr-2 font-sans">
        ...
        {totalGeral > 0 && (
          <div className="text-center text-[#1B4D3E] font-bold text-[10px] uppercase mb-12 tracking-wider">
            ({(typeof numeroPorExtenso !== 'undefined' && numeroPorExtenso?.porExtenso) ? numeroPorExtenso.porExtenso(totalGeral, numeroPorExtenso.estilo?.monetario) : ''})
          </div>
        )}
    </div>
  );
        ...
        <table className="w-full text-left border-collapse border border-slate-300 break-inside-avoid print:break-inside-avoid">
          <tbody>
            ...
            <tr className="border-b border-slate-300 text-[10px] text-slate-800">
              ...
              <td className="px-4 py-2 font-black text-slate-900">{fmt(totalGeral)} {totalGeral > 0 ? `(${(typeof numeroPorExtenso !== 'undefined' && numeroPorExtenso?.porExtenso) ? numeroPorExtenso.porExtenso(totalGeral, numeroPorExtenso.estilo?.monetario) : ''})` : ''}</td>
            </tr>
            <tr className="border-b border-slate-300 text-[10px] text-slate-800">
