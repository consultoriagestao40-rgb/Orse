...
function PropostaEditor() {
          ...
          if (fullData) {
            ...
            setProposta({
               ...
               cliente: { 
                 ...
                 vendedorTelefone: fullData.cliente.vendedorTelefone || loggedUser?.celular || '(41) 9 9737-0880',
  ...
  const executeSave = async (changelog: string, novaVersao: boolean) => {
    try {
      setSaving(true);
                            ...
                            <div className="print-slide w-full aspect-[16/9] border border-slate-200 bg-white grid grid-cols-2 relative overflow-hidden h-[100vh] text-slate-800">
                               <div className="col-span-1 bg-white p-16 flex flex-col justify-between relative h-full border-r border-slate-100">
                                  ...
                                  <div className="relative z-10 flex flex-col h-full justify-between">
                                     <div>
                                        <h2 className="text-3xl font-black text-[#1e4480] uppercase tracking-tight leading-none mb-8">PRINCIPAIS<br />FERRAMENTAS</h2>
                                     </div>
                                     <div className="space-y-6 my-auto">
                                        <div className="flex gap-4 items-start">
                                           <div className="bg-[#1e4480]/10 p-2 rounded-xl text-[#1e4480] shrink-0 mt-1"><Share2 size={20} className="stroke-[2.5]" /></div>
                                           <div className="space-y-1">
                                              <h3 className="text-[#1e4480] text-xs font-black tracking-wider uppercase">BITRIX24</h3>
                                              <p className="text-slate-500 text-[8.5px] font-semibold leading-relaxed">CRM, armazenamento de dados e documentos, gestão de resultados, planejamento estratégico.</p>
                                           </div>
                                        </div>
                                        <div className="flex gap-4 items-start">
                                           <div className="bg-[#1e4480]/10 p-2 rounded-xl text-[#1e4480] shrink-0 mt-1"><Clock size={20} className="stroke-[2.5]" /></div>
                                           <div className="space-y-1">
                                              <h3 className="text-[#1e4480] text-xs font-black tracking-wider uppercase">SECULLUM</h3>
                                              <p className="text-slate-500 text-[8.5px] font-semibold leading-relaxed">Controle de ponto digital, envio e assinatura de holerites e documentos administrativos.</p>
                                           </div>
                                        </div>
                                     </div>
                                     <div className="pt-4 border-t border-slate-100 flex items-center text-slate-400 text-[9px] font-bold uppercase tracking-widest"><span>www.grupojvsserv.com.br</span></div>
                                  </div>
                               </div>
                                  ...
                                  <div className="relative z-10 flex flex-col h-full justify-between">
                                     ...
                                     <div className="space-y-4 my-auto">
                                        <div className="flex gap-4 items-start border-b border-white/10 pb-3">
                                           <div className="bg-emerald-500/20 p-2 rounded-xl text-emerald-400 shrink-0 mt-1 border border-emerald-500/30"><Cpu size={20} className="stroke-[2.5]" /></div>
                                           <div className="space-y-1">
                                              ...
                                              <p className="text-white/80 text-[8px] font-semibold leading-relaxed">Mesa de operação inteligente baseada em IA, otimizando agendamentos de frotas, distribuição de escalas e monitoramento de serviços em tempo real.</p>
                                           </div>
                                        </div>
                                        <div className="flex gap-4 items-start">
                                           <div className="bg-white/10 p-2 rounded-xl text-white shrink-0 mt-1"><User size={20} className="stroke-[2.5]" /></div>
                                           <div className="space-y-1">
                                              <h3 className="text-white text-xs font-black tracking-wider uppercase">ONVIO</h3>
                                              <p className="text-white/80 text-[8.5px] font-semibold leading-relaxed">Registro e gestão de documentação de funcionários.</p>
                                           </div>
                                        </div>
                                        <div className="flex gap-4 items-start">
                                           <div className="bg-white/10 p-2 rounded-xl text-white shrink-0 mt-1"><Smartphone size={20} className="stroke-[2.5]" /></div>
                                           <div className="space-y-1">
                                              <h3 className="text-white text-xs font-black tracking-wider uppercase">CHECK-LIST FÁCIL</h3>
                                              <p className="text-white/80 text-[8.5px] font-semibold leading-relaxed">Plataforma digital de desenvolvimento e gestão de processos internos com registro fotográfico, SLA's etc.</p>
                                           </div>
                                        </div>
                                     </div>
